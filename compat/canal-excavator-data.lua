...
data:extend({{
  ...
  data = {
    ...
    mineResult = {
      {type="item", name = "spoilage", independent_probability = 0.95, amount = 1},
      {type="item", name = "luciferin", independent_probability = 0.05, amount = 1},
      {type="item", name = "chitin", independent_probability = 0.01, amount = 1},
      {type="item", name = "pentapod-egg", independent_probability = 0.01, amount = 1},
    },
