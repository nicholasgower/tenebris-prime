...
data:extend({
	...
	-- ========================================
	-- deep-space-sensing technology moved to deep-space-sensing mod
	{
		type = "technology",
		...
		prerequisites = { "railgun", "overgrowth-soil" },
		research_trigger = {
			type = "scripted",
	...
	},
	{
		...
		icons = {
			...
			{
				icon = "__tenebris-prime__/graphics/technology/gas-cloud-clean-air.png",
				icon_size = 1024,
				scale = 0.5,
				tint = tenebris.TINT.DARK_ATMOSPHERE,
			},
		},
		effects = {
			{
	...
	},
	{
		...
		icons = {
			{
				icon = "__tenebris-prime__/graphics/technology/metal-waste-copper.png",
				icon_size = 1024,
				shift = { -32, 0 },
			},
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Produce 10,000 [item=tenebris-circuit-waste]. Drop circuits from orbit onto [planet=tenebris] to corrode them into [item=tenebris-circuit-waste].",
			},
		},
	},
	{
		...
		icons = {
			{
				icon = "__tenebris-prime__/graphics/technology/ceramics-base.png",
				icon_size = 256,
				scale = 0.7,
				shift = { -24, -24 },
			},
			{
				icon = "__tenebris-prime__/graphics/technology/ceramics.png",
				icon_size = 1024,
				scale = 0.15,
				shift = { 32, 32 },
			},
	...
	-- ========================================
	{
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Launch [item=observation-satellite] and scan for Tenespace via Deep Space Sensing.",
			},
		},
	...
	},
	{
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"You have reached the end of the Tenebris Prime demo. More content coming soon!",
			},
		},
		prerequisites = {
	...
	},
	{
		...
		icons = PlanetsLib.technology_icon_planet(
			"__tenebris-prime__/graphics/icons/starmap-icon-lightless-gateway.png",
			4096
		),
		effects = {
			{
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Launch [item=observation-satellite] and scan for the Lightless Gateway via Deep Space Sensing.",
			},
		},
	...
	{
		type = "technology",
		name = quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_EXPLOSIVES,
		icons = {
			{
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Destroy "
					.. quartz_forest_constants.ORTET_DEATH_TO_TECHNOLOGY_UNLOCK_COUNTER_MAP[quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_EXPLOSIVES]
					.. " [entity=tenebris-quartz-forest-ortet] Quartz Forest Ortets.",
			},
		},
	},
	{
	...
	},
	{
		...
		effects = {
			...
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-citrine",
			},
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-onyx",
			},
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-prasiolite",
			},
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-amethyst",
			},
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-ruby-agate",
			},
			{
				type = "unlock-recipe",
				recipe = "crystal-oscillator-sapphire-agate",
			},
		},
		unit = {
			count = 5000,
		...
		prerequisites = { "piezoelectric-science-pack", quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_2 },
	},
	{
		type = "technology",
	...
	{
		type = "technology",
		name = quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_1,
		icons = {
			{
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Destroy "
					.. quartz_forest_constants.ORTET_DEATH_TO_TECHNOLOGY_UNLOCK_COUNTER_MAP[quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_1]
					.. " [entity=tenebris-quartz-forest-ortet] Quartz Forest Ortets.",
			},
		},
		prerequisites = { quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_EXPLOSIVES, "weapon-shooting-speed-6" },
	},
	{
		type = "technology",
		name = quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_2,
		icons = {
			{
				icon = "__base__/graphics/technology/explosive-rocketry.png",
				icon_size = 256,
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Destroy "
					.. quartz_forest_constants.ORTET_DEATH_TO_TECHNOLOGY_UNLOCK_COUNTER_MAP[quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_2]
					.. " [entity=tenebris-quartz-forest-ortet] Quartz Forest Ortets.",
			},
		},
		prerequisites = { "destroyer", "speed-module-3", quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_1 },
	},
	{
		type = "technology",
		name = quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_3,
		icons = {
			{
				icon = "__base__/graphics/technology/explosive-rocketry.png",
				icon_size = 256,
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Destroy "
					.. quartz_forest_constants.ORTET_DEATH_TO_TECHNOLOGY_UNLOCK_COUNTER_MAP[quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_3]
					.. " [entity=tenebris-quartz-forest-ortet] Quartz Forest Ortets.",
			},
		},
		prerequisites = { quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_2, "piezoelectric-science-pack" },
	},
	{
		type = "technology",
		name = quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_4,
		icons = {
			{
				icon = "__base__/graphics/technology/explosive-rocketry.png",
				icon_size = 256,
		...
		research_trigger = {
			...
			trigger_description = {
				"",
				"Destroy "
					.. quartz_forest_constants.ORTET_DEATH_TO_TECHNOLOGY_UNLOCK_COUNTER_MAP[quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_4]
					.. " [entity=tenebris-quartz-forest-ortet] Quartz Forest Ortets.",
			},
		},
		prerequisites = { quartz_forest_constants.TECHNOLOGIES.LUCIFERIN_KINETICS_3 },
	},
	{
		type = "technology",
