...
local function create_centipede(name, scale, length, health, speed, damage, min_spawn_distance)
    ...
    local head_overrides = {
        ...
        revenge_attack_parameters = "_nil",
        forward_padding = 0,
        backward_padding = 0,
        forward_overlap = 0,
        backward_overlap = 0,
    ...
    local tail_segment_overrides = {
        ...
        localised_name = { "entity-name.centipede-" .. name },
        update_effects = "_nil",
        update_effects_while_enraged = "_nil",
        dying_trigger_effect = "_nil",
        revenge_attack_parameters = "_nil",
        forward_padding = 0.0,
...
create_centipede("small", 0.8, settings.startup["tenebris-small-centipede-length"].value, 50000, 0.05, 1000, 50)
create_centipede("medium", 1.6, settings.startup["tenebris-medium-centipede-length"].value, 100000, 0.1, 3000, 300)
create_centipede("large", 2, settings.startup["tenebris-large-centipede-length"].value, 200000, 0.1, 5000, 1000)
create_centipede("giant", 3, settings.startup["tenebris-giant-centipede-length"].value, 500000, 0.1, 10000, 2000)
create_centipede("leviathan", 5, settings.startup["tenebris-giant-centipede-length"].value, 1000000, 0.1, 20000, 4000)
