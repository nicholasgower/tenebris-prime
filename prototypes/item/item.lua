...
data:extend({
    ...
    quick_item("bioluminescent-crystal", 100, 2 * kg, true, { fuel_categories = {"bioluminescent"}, fuel_value = "500kJ", }),
    quick_item("lucifunnel", 50, 2 * kg, true, { fuel_categories = {"chemical"}, fuel_value = "4MJ" }),
