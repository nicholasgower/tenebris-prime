...
atmosphere_distillation = build_group_ordering("atmosphere-distillation", "g")
cryogenic_process = build_group_ordering("cryogenic-process", "h")
orbital_harvesting = build_group_ordering("orbital-harvesting", "i")
casting = build_group_ordering("casting", "j")
weaponry = build_group_ordering("weaponry", "k")
waste_burning = build_group_ordering("waste-burning", "l")
...
order_data("technology", tenebris_tech, "ammonic-acidification", "ao")
order_data("technology", tenebris_tech, "bioluminescent-crystal", "ap")
order_data("technology", tenebris_tech, "tenebris-bioinfusor", "aq")
order_data("technology", tenebris_tech, "bioluminescent-science-pack", "ar")
order_data("technology", tenebris_tech, "photonic-derangement", "as")
order_data("technology", tenebris_tech, "bismuthal-alloys", "at")
order_data("technology", tenebris_tech, "tenebris-biobeacon", "au")
order_data("technology", tenebris_tech, "tenebris-laser-cannon", "av")
order_data("technology", tenebris_tech, "tenebris-laser-shooting-speed", "aw")
order_data("technology", tenebris_tech, "tenebris-beacon-distribution-efficiency", "ax")
order_data("technology", tenebris_tech, "cloaking", "ay")
order_data("technology", tenebris_tech, "bioluminescent-robots", "az")
order_data("technology", tenebris_tech, "worker-robot-battery-capacity", "ba")
order_data("technology", tenebris_tech, "bioluminescent-lamps", "bb")
order_data("technology", tenebris_tech, "deep-space-discovery-lightless-abyss", "bc")