...
order_data("item", mercury_products, "tenebris-mercurial-lattice", "g")
order_data("recipe", mercury_products, "tenebris-mercurial-lattice", "h")
...
order_data("technology", tenebris_tech, "piezoelectric-science-pack", "ai")
order_data("technology", tenebris_tech, "deep-space-discovery-tenespace", "aj")
...
-- order_data("technology", tenebris_tech, "photonic-derangement", "au") -- Removed - tech doesn't exist
