...
asteroid_functions.fulgora_big              = 0.000025
asteroid_functions.fulgora_huge             = 0.000025
asteroid_functions.system_edge_chunks       = 0.0005
asteroid_functions.system_edge_huge         = 0.00125
asteroid_functions.tenebris_chunks          = 0.0005
asteroid_functions.tenebris_big             = 0.005
asteroid_functions.tenebris_huge            = 0.00125
asteroid_functions.iridescent_river_chunks  = 0.00025
asteroid_functions.iridescent_river_huge    = 0.002
asteroid_functions.lightless_abyss_chunks   = 0.00005
...
asteroid_functions.fulgora_tenebris =
{
  probability_on_range_chunk =
  {
    ...
    {position = 0.9, probability = asteroid_functions.tenebris_chunks, angle_when_stopped = asteroid_functions.chunk_angle}
  },
  probability_on_range_big =
  {
    {position = 0.1, probability = asteroid_functions.fulgora_big, angle_when_stopped = asteroid_functions.huge_angle},
    {position = 0.9, probability = asteroid_functions.tenebris_big, angle_when_stopped = asteroid_functions.huge_angle}
  },
  probability_on_range_huge =
  {
    {position = 0.1, probability = asteroid_functions.fulgora_huge, angle_when_stopped = asteroid_functions.huge_angle},
    {position = 0.9, probability = asteroid_functions.tenebris_huge, angle_when_stopped = asteroid_functions.huge_angle}
  },
  type_ratios =
  {
    ...
    {position = 0.5, ratios = {9,  9,  2, 0}},
    {position = 0.6, ratios = {9, 11,  1, 0}},
    {position = 0.7, ratios = {4, 12,  0, 0}},
    {position = 0.8, ratios = {3, 15,  0, 0}},
    {position = 0.9, ratios = asteroid_functions.tenebris_ratio},
  }
}
...
asteroid_functions.tenebris_iridescent_river =
{
  ...
  probability_on_range_chunk =
  {
    ...
    {position = 0.9, probability = asteroid_functions.iridescent_river_chunks, angle_when_stopped = asteroid_functions.chunk_angle}
  },
  probability_on_range_huge =
  {
    {position = 0.1, probability = asteroid_functions.tenebris_huge, angle_when_stopped = asteroid_functions.huge_angle},
    {position = 0.9, probability = asteroid_functions.iridescent_river_huge, angle_when_stopped = asteroid_functions.huge_angle}
  },
  type_ratios =
  {
    {position = 0.1, ratios = asteroid_functions.tenebris_ratio},
    {position = 0.2, ratios = {4,  4,  1, 0, 2}},
    {position = 0.3, ratios = {5,  3,  2, 0, 4}},
    {position = 0.4, ratios = {6,  3,  2, 0, 5}},
    {position = 0.5, ratios = {9,  2,  2, 0, 8}},
    {position = 0.6, ratios = {9,  3,  4, 0, 12}},
    {position = 0.7, ratios = {4,  3,  5, 0, 17}},
    {position = 0.8, ratios = {3,  4,  5, 0, 20}},
    {position = 0.9, ratios = asteroid_functions.iridescent_river_ratio},
  }
}
...
asteroid_functions.tenebris_lightless_abyss =
{
  ...
  probability_on_range_huge =
  {
    {position = 0.001, probability = 0, angle_when_stopped = asteroid_functions.huge_angle},
    {position = 0.1, probability = 0.001, angle_when_stopped = asteroid_functions.huge_angle},
    {position = 0.9, probability = 0, angle_when_stopped = asteroid_functions.huge_angle}
  },
  type_ratios =
  {
    {position = 0.001, ratios = asteroid_functions.tenebris_ratio},
    {position = 0.1, ratios = {1,  0.001,  0, 0}},
    {position = 0.2, ratios = {0.001,  0.00001,  0, 0}},
    {position = 0.3, ratios = {0.001,  0.0000001,  0, 0}},
    {position = 0.4, ratios = {0.0001,  0,  0, 0}},
    {position = 0.5, ratios = {0.0001,  0,  0, 0}},
    {position = 0.6, ratios = {0.00001,  0,  0, 0}},
    {position = 0.7, ratios = {0.00001,  0,  0, 0}},
    {position = 0.8, ratios = {0.000001,  0,  0, 0}},
    {position = 0.9, ratios = asteroid_functions.lightless_abyss_ratio},
  }
}
    ...
    if planet == nil or planet == significant_position then
      ...
      if planet == nil then
        spawn_point = {
            ...
            probability = interpolated_probability * interpolated_ratio[asteroid_type], 
...
asteroid_functions.spawn_definitions = function(data, planet)
  ...
  if data.has_iridescent_asteroids == true then
    asteroid_types = {"metallic", "carbonic", "oxide", "bismuth"}
  end
  ...
  for k, asteroid_size in pairs(asteroid_sizes) do
    for k, asteroid_type in pairs(asteroid_types) do
      ...
      elseif asteroid_type == "oxide" then
        asteroid_id = 3
      elseif asteroid_type == "bismuth" then
        asteroid_id = 5
      else
        asteroid_id = 4
      end
