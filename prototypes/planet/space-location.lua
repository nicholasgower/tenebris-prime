...
local tenebris = meld(table.deepcopy(data.raw["planet"]["gleba"]), {
	...
	player_effects = { -- TODO: replace with shader & find a way to have rain appear and disappear with weather system.
		type = "cluster",
		cluster_count = 100,
		distance = 2,
...
local iridescent_river = { -- Bismuth harvesting route
	...
	label_orientation = 0.15,
	asteroid_spawn_influence = 1,
	asteroid_spawn_definitions = tenebris_asteroid_util.spawn_definitions(
		tenebris_asteroid_util.tenebris_iridescent_river,
		0.9
	),
