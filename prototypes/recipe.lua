...
local crystal_icons = {
	...
	["onyx"] = {
		icon = "__tenebris-prime__/graphics/icons/crystals/onyx.png",
		icon_size = 64,
		tint = tenebris.TINT.ONYX,
	},
	["prasiolite"] = {
...
for _, recipe in
	ipairs(
		create_crystal_variant_recipes("tenebris-heated-agricultural-tower", heated_agricultural_tower_template, 10, {
...
for _, recipe in
	ipairs(create_crystal_variant_recipes("piezoelectric-inserter", piezoelectric_inserter_template, 1, {
...
local all_recipes = {
	...
	},
	{
		...
		results = {
			{ type = "item", name = "luciferin-rocket-fuel", amount = 2 },
		},
		allow_productivity = true,
	},
	{
	...
	-- ========================================
	-- SPACE & OBSERVATION (moved to deep-space-sensing mod)
	-- ========================================
	{
		type = "recipe",
	...
	},
	{
		...
		auto_recycle = false,
		ingredients = {
			{ type = "item", name = "luciferin-rocket-fuel", amount = 1 },
			{ type = "item", name = "carbon-fiber", amount = 1 },
			{ type = "item", name = "tenebris-ceramic-circuitry", amount = 1 },
			{ type = "item", name = "tenebris-crystal-oscillator", amount = 1 },
		},
			...
			results = {
				{
					...
					amount = piezo.RECIPE.fluid_output,
					temperature = piezo.FLUID.output_temperature,
				},
			},
		}
	end)(),
	...
	-- ========================================
	{
		...
		results = {
			{ type = "item", name = "displacer-capsule", amount = 1 },
		},
		auto_recycle = true,
	},
}
